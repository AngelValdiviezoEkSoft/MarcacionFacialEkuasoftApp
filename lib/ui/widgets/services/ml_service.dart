...
class MLService {
  ...
  Future<UserFotoModel?> predict() async {
  ...
  Future<UserFotoModel?> _searchResult(List predictedData) async {
    DatabaseHelper _dbHelper = DatabaseHelper.instance;

    List<UserFotoModel> users = await _dbHelper.queryAllUsers();
    double minDist = 999;
    double currDist = 0.0;
    UserFotoModel? predictedResult;

    //print('users.length=> ${users.length}');

    for (UserFotoModel u in users) {
